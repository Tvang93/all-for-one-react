...
const Magic8BallComponent = () => {
  ...
  return (
    <>
      <section className="flex flex-col items-center justify-center px-15 py-10 md:px-55 lg:py-0 lg:pt-20 lg:items-start lg:pl-50 2xl:pl-40 2xl:pr-90 bg-[url(../assets/img/pipboy-man.png)] bg-no-repeat bg-center bg-[330px,430px] lg:bg-none">
