...
const ReverseItNumOnlyComponent = () => {
  ...
  return (
    <>
      <section class="flex flex-col items-center justify-center px-15 py-45 md:px-55 lg:py-0 lg:pt-20 lg:items-start lg:pl-50 2xl:pl-40 2xl:pr-90 bg-[url(../assets/img/pipboy-man.png)] bg-no-repeat bg-center bg-[330px,430px] lg:bg-none">
        ...
        <div
          id="inputContainer"
          class="flex flex-col text-[#00FF2C] self-start"
        >
          <input
            id="inputField"
            class="inline border-1 border-[#00FF2C] text-[2rem] lg:text-[3.5rem] xl:text-[4rem] text-[#00FF2C] w-[300px] lg:w-[750px] xl:w-[940px] bg-transparent"
            type="number"
