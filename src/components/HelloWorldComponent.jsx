...
const HelloWorldComponent = () => {
  ...
  return (
    <section className="flex flex-col items-center justify-center px-[60px] py-40 sm:px-[220px] lg:py-0 lg:pt-20 lg:items-start lg:pl-[200px] 2xl:pl-[400px] bg-[url(./assets/pipboy-man.png)] bg-no-repeat bg-center bg-[330px,430px] lg:bg-none">
